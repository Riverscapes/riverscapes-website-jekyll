...
In the video below Philip Bailey of [North Arrow Research](https://northarrowresearch.com) illustrates how such a PWA can work (don't get too excited, its a western town movie set, it is not actually fully plumbed yet ~ i.e. its a [proof of concept]({{site.baseurl}}/Tools/discrimination.html#tool-grade) level of development):
